...
void TuLuyen::BUY_TU_LUYEN(LPOBJ lpObj, BUY_TU_LUYEN_REQ *aRecv)
{
	if (aRecv->Number == 1)
	{
		...
		if (lpObj->rTuLuyen < 1)
		{
			...
			GDSetCoinSend(lpObj->Index, -(this->TU_LUYEN_WCOINC_01), 0, 0, "Tu Luyen");
		...
		else if (lpObj->rTuLuyen < 2)
		{
			...
			GDSetCoinSend(lpObj->Index, -(this->TU_LUYEN_WCOINC_02), 0, 0, "Tu Luyen");
			//gCashShop.CGCashShopPointRecv(lpObj->Index);
			lpObj->rTuLuyen += 1; // Thay Đổi
		...
		else if (lpObj->rTuLuyen < 3)
		{
			...
			GDSetCoinSend(lpObj->Index, -(this->TU_LUYEN_WCOINC_03), 0, 0, "Tu Luyen");
			//gCashShop.CGCashShopPointRecv(lpObj->Index);
			lpObj->rTuLuyen += 1; // Thay Đổi
		...
		else if (lpObj->rTuLuyen < 4)
		{
			...
			GDSetCoinSend(lpObj->Index, -(this->TU_LUYEN_WCOINC_04), 0, 0, "Tu Luyen");
			//gCashShop.CGCashShopPointRecv(lpObj->Index);
			lpObj->rTuLuyen += 1; // Thay Đổi
		...
		else if (lpObj->rTuLuyen < 5)
		{
			...
			GDSetCoinSend(lpObj->Index, -(this->TU_LUYEN_WCOINC_05), 0, 0, "Tu Luyen");
			//gCashShop.CGCashShopPointRecv(lpObj->Index);
			lpObj->rTuLuyen += 1; // Thay Đổi
		...
		else if (lpObj->rTuLuyen < 6)
		{
			...
			GDSetCoinSend(lpObj->Index, -(this->TU_LUYEN_WCOINC_06), 0, 0, "Tu Luyen");
			//gCashShop.CGCashShopPointRecv(lpObj->Index);
			lpObj->rTuLuyen += 1; // Thay Đổi
		...
		else if (lpObj->rTuLuyen < 7)
		{
			...
			GDSetCoinSend(lpObj->Index, -(this->TU_LUYEN_WCOINC_07), 0, 0, "Tu Luyen");
			//gCashShop.CGCashShopPointRecv(lpObj->Index);
			lpObj->rTuLuyen += 1; // Thay Đổi
		...
		else if (lpObj->rTuLuyen < 8)
		{
			...
			GDSetCoinSend(lpObj->Index, -(this->TU_LUYEN_WCOINC_08), 0, 0, "Tu Luyen");
			//gCashShop.CGCashShopPointRecv(lpObj->Index);
			lpObj->rTuLuyen += 1; // Thay Đổi
		...
		else if (lpObj->rTuLuyen < 9)
		{
			...
			GDSetCoinSend(lpObj->Index, -(this->TU_LUYEN_WCOINC_09), 0, 0, "Tu Luyen");
			//gCashShop.CGCashShopPointRecv(lpObj->Index);
			lpObj->rTuLuyen += 1; // Thay Đổi
		...
		else if (lpObj->rTuLuyen < 10)
		{
			...
			GDSetCoinSend(lpObj->Index, -(this->TU_LUYEN_WCOINC_10), 0, 0, "Tu Luyen");
			//gCashShop.CGCashShopPointRecv(lpObj->Index);
			lpObj->rTuLuyen += 1; // Thay Đổi
		...
		else if (lpObj->rTuLuyen < 11)
		{
			...
			GDSetCoinSend(lpObj->Index, -(this->TU_LUYEN_WCOINC_11), 0, 0, "Tu Luyen");
			//gCashShop.CGCashShopPointRecv(lpObj->Index);
			lpObj->rTuLuyen += 1; // Thay Đổi
		...
		else if (lpObj->rTuLuyen < 12)
		{
			...
			GDSetCoinSend(lpObj->Index, -(this->TU_LUYEN_WCOINC_12), 0, 0, "Tu Luyen");
			//gCashShop.CGCashShopPointRecv(lpObj->Index);
			lpObj->rTuLuyen += 1; // Thay Đổi
		...
		else if (lpObj->rTuLuyen < 13)
		{
			...
			GDSetCoinSend(lpObj->Index, -(this->TU_LUYEN_WCOINC_13), 0, 0, "Tu Luyen");
			//gCashShop.CGCashShopPointRecv(lpObj->Index);
			lpObj->rTuLuyen += 1; // Thay Đổi
		...
		else if (lpObj->rTuLuyen < 14)
		{
			...
			GDSetCoinSend(lpObj->Index, -(this->TU_LUYEN_WCOINC_14), 0, 0, "Tu Luyen");
			//gCashShop.CGCashShopPointRecv(lpObj->Index);
			lpObj->rTuLuyen += 1; // Thay Đổi
		...
		else if (lpObj->rTuLuyen < 15)
		{
			...
			GDSetCoinSend(lpObj->Index, -(this->TU_LUYEN_WCOINC_15), 0, 0, "Tu Luyen");
			//gCashShop.CGCashShopPointRecv(lpObj->Index);
			lpObj->rTuLuyen += 1; // Thay Đổi
		...
		else if (lpObj->rTuLuyen < 16)
		{
			...
			GDSetCoinSend(lpObj->Index, -(this->TU_LUYEN_WCOINC_16), 0, 0, "Tu Luyen");
			//gCashShop.CGCashShopPointRecv(lpObj->Index);
			lpObj->rTuLuyen += 1; // Thay Đổi
		...
		else if (lpObj->rTuLuyen < 17)
		{
			...
			GDSetCoinSend(lpObj->Index, -(this->TU_LUYEN_WCOINC_17), 0, 0, "Tu Luyen");
			//gCashShop.CGCashShopPointRecv(lpObj->Index);
			lpObj->rTuLuyen += 1; // Thay Đổi
		...
		else if (lpObj->rTuLuyen < 18)
		{
			...
			GDSetCoinSend(lpObj->Index, -(this->TU_LUYEN_WCOINC_18), 0, 0, "Tu Luyen");
			//gCashShop.CGCashShopPointRecv(lpObj->Index);
			lpObj->rTuLuyen += 1; // Thay Đổi
		...
		else if (lpObj->rTuLuyen < 19)
		{
			...
			GDSetCoinSend(lpObj->Index, -(this->TU_LUYEN_WCOINC_19), 0, 0, "Tu Luyen");
			//gCashShop.CGCashShopPointRecv(lpObj->Index);
			lpObj->rTuLuyen += 1; // Thay Đổi
		...
		else if (lpObj->rTuLuyen < 20)
		{
			...
			GDSetCoinSend(lpObj->Index, -(this->TU_LUYEN_WCOINC_20), 0, 0, "Tu Luyen");
			//gCashShop.CGCashShopPointRecv(lpObj->Index);
			lpObj->rTuLuyen += 1; // Thay Đổi
		...
		else if (lpObj->rTuLuyen < 21)
		{
			...
			GDSetCoinSend(lpObj->Index, -(this->TU_LUYEN_WCOINC_21), 0, 0, "Tu Luyen");
			//gCashShop.CGCashShopPointRecv(lpObj->Index);
			lpObj->rTuLuyen += 1; // Thay Đổi
		...
		else if (lpObj->rTuLuyen < 22)
		{
			...
			GDSetCoinSend(lpObj->Index, -(this->TU_LUYEN_WCOINC_22), 0, 0, "Tu Luyen");
			//gCashShop.CGCashShopPointRecv(lpObj->Index);
			lpObj->rTuLuyen += 1; // Thay Đổi
		...
		else if (lpObj->rTuLuyen < 23)
		{
			...
			GDSetCoinSend(lpObj->Index, -(this->TU_LUYEN_WCOINC_23), 0, 0, "Tu Luyen");
			//gCashShop.CGCashShopPointRecv(lpObj->Index);
			lpObj->rTuLuyen += 1; // Thay Đổi
		...
		else if (lpObj->rTuLuyen < 24)
		{
			...
			GDSetCoinSend(lpObj->Index, -(this->TU_LUYEN_WCOINC_24), 0, 0, "Tu Luyen");
			//gCashShop.CGCashShopPointRecv(lpObj->Index);
			lpObj->rTuLuyen += 1; // Thay Đổi
		...
		else if (lpObj->rTuLuyen < 25)
		{
			...
			GDSetCoinSend(lpObj->Index, -(this->TU_LUYEN_WCOINC_25), 0, 0, "Tu Luyen");
			//gCashShop.CGCashShopPointRecv(lpObj->Index);
			lpObj->rTuLuyen += 1; // Thay Đổi
		...
		else if (lpObj->rTuLuyen < 26)
		{
			...
			GDSetCoinSend(lpObj->Index, -(this->TU_LUYEN_WCOINC_26), 0, 0, "Tu Luyen");
			//gCashShop.CGCashShopPointRecv(lpObj->Index);
			lpObj->rTuLuyen += 1; // Thay Đổi
		...
		else if (lpObj->rTuLuyen < 27)
		{
			...
			GDSetCoinSend(lpObj->Index, -(this->TU_LUYEN_WCOINC_27), 0, 0, "Tu Luyen");
			//gCashShop.CGCashShopPointRecv(lpObj->Index);
			lpObj->rTuLuyen += 1; // Thay Đổi
		...
		else if (lpObj->rTuLuyen < 28)
		{
			...
			GDSetCoinSend(lpObj->Index, -(this->TU_LUYEN_WCOINC_28), 0, 0, "Tu Luyen");
			//gCashShop.CGCashShopPointRecv(lpObj->Index);
			lpObj->rTuLuyen += 1; // Thay Đổi
		...
		else if (lpObj->rTuLuyen < 29)
		{
			...
			GDSetCoinSend(lpObj->Index, -(this->TU_LUYEN_WCOINC_29), 0, 0, "Tu Luyen");
			//gCashShop.CGCashShopPointRecv(lpObj->Index);
			lpObj->rTuLuyen += 1; // Thay Đổi
		...
		else if (lpObj->rTuLuyen < 30)
		{
			...
			GDSetCoinSend(lpObj->Index, -(this->TU_LUYEN_WCOINC_30), 0, 0, "Tu Luyen");
			//gCashShop.CGCashShopPointRecv(lpObj->Index);
			lpObj->rTuLuyen += 1; // Thay Đổi
		...
		else if (lpObj->rTuLuyen < 31)
		{
			...
			GDSetCoinSend(lpObj->Index, -(this->TU_LUYEN_WCOINC_31), 0, 0, "Tu Luyen");
			//gCashShop.CGCashShopPointRecv(lpObj->Index);
			lpObj->rTuLuyen += 1; // Thay Đổi
		...
		else if (lpObj->rTuLuyen < 32)
		{
			...
			GDSetCoinSend(lpObj->Index, -(this->TU_LUYEN_WCOINC_32), 0, 0, "Tu Luyen");
			//gCashShop.CGCashShopPointRecv(lpObj->Index);
			lpObj->rTuLuyen += 1; // Thay Đổi
		...
		else if (lpObj->rTuLuyen < 33)
		{
			...
			GDSetCoinSend(lpObj->Index, -(this->TU_LUYEN_WCOINC_33), 0, 0, "Tu Luyen");
			//gCashShop.CGCashShopPointRecv(lpObj->Index);
			lpObj->rTuLuyen += 1; // Thay Đổi
		...
		else if (lpObj->rTuLuyen < 34)
		{
			...
			GDSetCoinSend(lpObj->Index, -(this->TU_LUYEN_WCOINC_34), 0, 0, "Tu Luyen");
			//gCashShop.CGCashShopPointRecv(lpObj->Index);
			lpObj->rTuLuyen += 1; // Thay Đổi
		...
		else if (lpObj->rTuLuyen < 35)
		{
			...
			GDSetCoinSend(lpObj->Index, -(this->TU_LUYEN_WCOINC_35), 0, 0, "Tu Luyen");
			//gCashShop.CGCashShopPointRecv(lpObj->Index);
			lpObj->rTuLuyen += 1; // Thay Đổi
		...
		else if (lpObj->rTuLuyen < 36)
		{
			...
			GDSetCoinSend(lpObj->Index, -(this->TU_LUYEN_WCOINC_36), 0, 0, "Tu Luyen");
			//gCashShop.CGCashShopPointRecv(lpObj->Index);
			lpObj->rTuLuyen += 1; // Thay Đổi
		...
		else if (lpObj->rTuLuyen < 37)
		{
			...
			GDSetCoinSend(lpObj->Index, -(this->TU_LUYEN_WCOINC_37), 0, 0, "Tu Luyen");
			//gCashShop.CGCashShopPointRecv(lpObj->Index);
			lpObj->rTuLuyen += 1; // Thay Đổi
		...
		else if (lpObj->rTuLuyen < 38)
		{
			...
			GDSetCoinSend(lpObj->Index, -(this->TU_LUYEN_WCOINC_38), 0, 0, "Tu Luyen");
			//gCashShop.CGCashShopPointRecv(lpObj->Index);
			lpObj->rTuLuyen += 1; // Thay Đổi
		...
		else if (lpObj->rTuLuyen < 39)
		{
			...
			GDSetCoinSend(lpObj->Index, -(this->TU_LUYEN_WCOINC_39), 0, 0, "Tu Luyen");
			//gCashShop.CGCashShopPointRecv(lpObj->Index);
			lpObj->rTuLuyen += 1; // Thay Đổi
		...
		else if (lpObj->rTuLuyen < 40)
		{
			...
			GDSetCoinSend(lpObj->Index, -(this->TU_LUYEN_WCOINC_40), 0, 0, "Tu Luyen");
			//gCashShop.CGCashShopPointRecv(lpObj->Index);
			lpObj->rTuLuyen += 1; // Thay Đổi
