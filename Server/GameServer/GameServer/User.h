...
#if (CUSTOM_GIOIHAN == 1)
	GIOIHAN_USER_DATA GIOIHAN;
#endif

#if(MUUNAFK == 1) //29-03-2022
	MUUNAFK_USER_DATA MUUNPETAFK;
#endif

#if (PHUKIEN_NEW == 1)
	PHUKIEN_USER_DATA PHUKIEN;
#endif
...
//MC bot
	...
	int MoveEventRunRongDo;
	int MoveEventRunHoangKim;
	int MoveEventRunPhuThuy;
	int MoveEventRunJunie;
	int MoveEventRunThoNgoc;
	int MoveEventRunHoaDiemQuy;
	int MoveEventRunSanta;
