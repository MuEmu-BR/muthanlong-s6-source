...
enum eSkillNumber
{
	SKILL_NONE = 0,
	SKILL_POISON = 1,
	SKILL_METEORITE = 2, // Quả Cầu Lửa Trên rơi xuống
	SKILL_LIGHTNING = 3,
	SKILL_FIRE_BALL = 4, // Quả Cầu Lửa
	SKILL_FLAME = 5,
	...
	SKILL_HEAL = 26, // Buf EF
	SKILL_GREATER_DEFENSE = 27, // Buf EF
	SKILL_GREATER_DAMAGE = 28, // Buf EF
	SKILL_SUMMON1 = 30,
	SKILL_SUMMON2 = 31,
	SKILL_SUMMON3 = 32,
	SKILL_SUMMON4 = 33,
	...
	SKILL_MANA_GLAIVE = 45, // Skill phóng dao
	SKILL_STAR_FALL = 46, // Skill Hay
	SKILL_IMPALE = 47,
	SKILL_GREATER_LIFE = 48, // Gồng máu
	SKILL_FIRE_BREATH = 49, // Phóng tia bọt sáng
	...
	// DL
	SKILL_FORCE = 60,
	SKILL_FIRE_BURST = 61, // Quang xich DL
	SKILL_EARTHQUAKE = 62,
	SKILL_SUMMON_PARTY = 63,
	SKILL_GREATER_CRITICAL_DAMAGE = 64, // DL buff dame
	...
	SKILL_SLEEP = 219,
	SKILL_LESSER_DAMAGE = 221, // Giảm Sức Đánh SM
	...
	SKILL_DARK_SIDE = 263, // ALLH
	SKILL_DRAGON_LORE = 264, // Gầm Thét RF
