...
#if(CUSTOM_GIOIHAN == 1) // Devil
	lpObj->GIOIHAN.DevilSquare += 1;
	gCustomGioiHan.GDSaveUserInfo(lpObj->Index);
	gNotice.GCNoticeSend(lpObj->Index, 1, 0, 0, 0, 0, 0, gCustomGioiHan.Msg05, lpObj->GIOIHAN.DevilSquare, gCustomGioiHan.m_DevilSquareCount);
#endif
	LogAdd(LOG_RED, "[DevilSquare] Da Vao Trong DevilSquare");
}
