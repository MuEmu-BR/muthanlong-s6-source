...
void ShopPointEx::AddTimeBonus(int UserIndex)
{
	...
	// Fix
	GDSetCoinSend(UserIndex, +(this->m_TimeBonusWCoinC), +(this->m_TimeBonusWCoinP), +(this->m_TimeBonusWCoinG), "AddTimeBonus");
	//gCashShop.CGCashShopPointRecv(UserIndex);
	// ----
...
void ShopPointEx::AddEventBonus(int UserIndex, ShopPointExEvent::T Event)
{
	...
	//Fix
	GDSetCoinSend(UserIndex, +(this->m_EventBonus[Event].AddCoinC), +(this->m_EventBonus[Event].AddCoinP), +(this->m_EventBonus[Event].AddCoinG), "AddEventBonus");
	//gCashShop.CGCashShopPointRecv(UserIndex);
...
void ShopPointEx::AddMonsterBonus(LPOBJ lpMonster, LPOBJ lpObj)
{
	...
	//Fix
	GDSetCoinSend(lpObj->Index, +(this->m_MobsData[MonsterSlot].AddCoinC), +(this->m_MobsData[MonsterSlot].AddCoinP), +(this->m_MobsData[MonsterSlot].AddCoinG), "AddMonsterBonus");
