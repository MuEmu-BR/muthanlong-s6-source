...
{
	this->MAX_THUOC_TINH_02 = GetPrivateProfileInt("Config", "MAX_THUOC_TINH_02", 0, gPath.GetFullPath("VanThanh\\CustomSachThuocTinh.ini"));
	this->MAX_THUOC_TINH_03 = GetPrivateProfileInt("Config", "MAX_THUOC_TINH_03", 0, gPath.GetFullPath("VanThanh\\CustomSachThuocTinh.ini"));
	this->MAX_THUOC_TINH_04 = GetPrivateProfileInt("Config", "MAX_THUOC_TINH_04", 0, gPath.GetFullPath("VanThanh\\CustomSachThuocTinh.ini"));
	this->MAX_THUOC_TINH_05 = GetPrivateProfileInt("Config", "MAX_THUOC_TINH_05", 0, gPath.GetFullPath("VanThanh\\CustomSachThuocTinh.ini"));
	this->MAX_THUOC_TINH_06 = GetPrivateProfileInt("Config", "MAX_THUOC_TINH_06", 0, gPath.GetFullPath("VanThanh\\CustomSachThuocTinh.ini"));
	this->MAX_THUOC_TINH_07 = GetPrivateProfileInt("Config", "MAX_THUOC_TINH_07", 0, gPath.GetFullPath("VanThanh\\CustomSachThuocTinh.ini"));

	GetPrivateProfileString("Text", "MSG_01", "BAN DA DAT CAP DO TOI DA", MSG_01, 1024, gPath.GetFullPath("VanThanh\\CustomSachThuocTinh.ini"));
	GetPrivateProfileString("Text", "MSG_02", "BAN CAN 1 %s SACH THUOC TINH", MSG_02, 1024, gPath.GetFullPath("VanThanh\\CustomSachThuocTinh.ini"));

	this->OPTION_LEVEL_01 = GetPrivateProfileInt("Option", "OPTION_LEVEL_01", 0, gPath.GetFullPath("VanThanh\\CustomSachThuocTinh.ini"));
	this->OPTION_LEVEL_02 = GetPrivateProfileInt("Option", "OPTION_LEVEL_02", 0, gPath.GetFullPath("VanThanh\\CustomSachThuocTinh.ini"));
	this->OPTION_LEVEL_03 = GetPrivateProfileInt("Option", "OPTION_LEVEL_03", 0, gPath.GetFullPath("VanThanh\\CustomSachThuocTinh.ini"));
	this->OPTION_LEVEL_04 = GetPrivateProfileInt("Option", "OPTION_LEVEL_04", 0, gPath.GetFullPath("VanThanh\\CustomSachThuocTinh.ini"));
	this->OPTION_LEVEL_05 = GetPrivateProfileInt("Option", "OPTION_LEVEL_05", 0, gPath.GetFullPath("VanThanh\\CustomSachThuocTinh.ini"));
	this->OPTION_LEVEL_06 = GetPrivateProfileInt("Option", "OPTION_LEVEL_06", 0, gPath.GetFullPath("VanThanh\\CustomSachThuocTinh.ini"));
	this->OPTION_LEVEL_07 = GetPrivateProfileInt("Option", "OPTION_LEVEL_07", 0, gPath.GetFullPath("VanThanh\\CustomSachThuocTinh.ini"));
	this->OPTION_LEVEL_08 = GetPrivateProfileInt("Option", "OPTION_LEVEL_08", 0, gPath.GetFullPath("VanThanh\\CustomSachThuocTinh.ini"));
	this->OPTION_LEVEL_09 = GetPrivateProfileInt("Option", "OPTION_LEVEL_09", 0, gPath.GetFullPath("VanThanh\\CustomSachThuocTinh.ini"));
	this->OPTION_LEVEL_10 = GetPrivateProfileInt("Option", "OPTION_LEVEL_10", 0, gPath.GetFullPath("VanThanh\\CustomSachThuocTinh.ini"));
	this->OPTION_LEVEL_11 = GetPrivateProfileInt("Option", "OPTION_LEVEL_11", 0, gPath.GetFullPath("VanThanh\\CustomSachThuocTinh.ini"));
	this->OPTION_LEVEL_12 = GetPrivateProfileInt("Option", "OPTION_LEVEL_12", 0, gPath.GetFullPath("VanThanh\\CustomSachThuocTinh.ini"));

	this->OPTION_ACTIVE_01 = GetPrivateProfileInt("Option", "OPTION_ACTIVE_01", 0, gPath.GetFullPath("VanThanh\\CustomSachThuocTinh.ini"));
	this->OPTION_ACTIVE_02 = GetPrivateProfileInt("Option", "OPTION_ACTIVE_02", 0, gPath.GetFullPath("VanThanh\\CustomSachThuocTinh.ini"));
	this->OPTION_ACTIVE_03 = GetPrivateProfileInt("Option", "OPTION_ACTIVE_03", 0, gPath.GetFullPath("VanThanh\\CustomSachThuocTinh.ini"));
	this->OPTION_ACTIVE_04 = GetPrivateProfileInt("Option", "OPTION_ACTIVE_04", 0, gPath.GetFullPath("VanThanh\\CustomSachThuocTinh.ini"));
	this->OPTION_ACTIVE_05 = GetPrivateProfileInt("Option", "OPTION_ACTIVE_05", 0, gPath.GetFullPath("VanThanh\\CustomSachThuocTinh.ini"));
	this->OPTION_ACTIVE_06 = GetPrivateProfileInt("Option", "OPTION_ACTIVE_06", 0, gPath.GetFullPath("VanThanh\\CustomSachThuocTinh.ini"));
	this->OPTION_ACTIVE_07 = GetPrivateProfileInt("Option", "OPTION_ACTIVE_07", 0, gPath.GetFullPath("VanThanh\\CustomSachThuocTinh.ini"));
	this->OPTION_ACTIVE_08 = GetPrivateProfileInt("Option", "OPTION_ACTIVE_08", 0, gPath.GetFullPath("VanThanh\\CustomSachThuocTinh.ini"));
	this->OPTION_ACTIVE_09 = GetPrivateProfileInt("Option", "OPTION_ACTIVE_09", 0, gPath.GetFullPath("VanThanh\\CustomSachThuocTinh.ini"));
	this->OPTION_ACTIVE_10 = GetPrivateProfileInt("Option", "OPTION_ACTIVE_10", 0, gPath.GetFullPath("VanThanh\\CustomSachThuocTinh.ini"));
	this->OPTION_ACTIVE_11 = GetPrivateProfileInt("Option", "OPTION_ACTIVE_11", 0, gPath.GetFullPath("VanThanh\\CustomSachThuocTinh.ini"));
	this->OPTION_ACTIVE_12 = GetPrivateProfileInt("Option", "OPTION_ACTIVE_12", 0, gPath.GetFullPath("VanThanh\\CustomSachThuocTinh.ini"));
}
// -------------------------------------------------------------------------------
