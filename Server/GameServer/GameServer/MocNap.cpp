...
void CMocNap::GDSaveData(int aIndex)
{
	...
	//--
	pRequest.MOCNAPCOIN = lpUser->QUANAP.MOCNAPCOIN;
...
void CMocNap::DGGetData(MOCNAP_DG_GET_DATA * aRecv)
{
	...
	// ----
	if (aRecv->MOCNAPCOIN < 0)
	{
		aRecv->MOCNAPCOIN = 0;
	}
	else if(aRecv->MOCNAP1 < 0)
	{
		aRecv->MOCNAP1 = 0;
	}
	...
	// ----
	lpUser->QUANAP.MOCNAPCOIN = aRecv->MOCNAPCOIN;
...
void CMocNap::Load()
{
	this->MocNapCheck1 = GetPrivateProfileInt("Config", "MocNapCheck1", 0, gPath.GetFullPath("VanThanh\\CustomMocNap.ini"));
	this->MocNapCheck2 = GetPrivateProfileInt("Config", "MocNapCheck2", 0, gPath.GetFullPath("VanThanh\\CustomMocNap.ini"));
	this->MocNapCheck3 = GetPrivateProfileInt("Config", "MocNapCheck3", 0, gPath.GetFullPath("VanThanh\\CustomMocNap.ini"));
	this->MocNapCheck4 = GetPrivateProfileInt("Config", "MocNapCheck4", 0, gPath.GetFullPath("VanThanh\\CustomMocNap.ini"));
	this->MocNapCheck5 = GetPrivateProfileInt("Config", "MocNapCheck5", 0, gPath.GetFullPath("VanThanh\\CustomMocNap.ini"));
	this->MocNapCheck6 = GetPrivateProfileInt("Config", "MocNapCheck6", 0, gPath.GetFullPath("VanThanh\\CustomMocNap.ini"));
	this->MocNapCheck7 = GetPrivateProfileInt("Config", "MocNapCheck7", 0, gPath.GetFullPath("VanThanh\\CustomMocNap.ini"));
	this->MocNapCheck8 = GetPrivateProfileInt("Config", "MocNapCheck8", 0, gPath.GetFullPath("VanThanh\\CustomMocNap.ini"));
	this->MocNapCheck9 = GetPrivateProfileInt("Config", "MocNapCheck9", 0, gPath.GetFullPath("VanThanh\\CustomMocNap.ini"));
	this->MocNapCheck10 = GetPrivateProfileInt("Config", "MocNapCheck10", 0, gPath.GetFullPath("VanThanh\\CustomMocNap.ini"));
	this->MocNapCheck11 = GetPrivateProfileInt("Config", "MocNapCheck11", 0, gPath.GetFullPath("VanThanh\\CustomMocNap.ini"));
	this->MocNapCheck12 = GetPrivateProfileInt("Config", "MocNapCheck12", 0, gPath.GetFullPath("VanThanh\\CustomMocNap.ini"));
	this->MocNapCheck13 = GetPrivateProfileInt("Config", "MocNapCheck13", 0, gPath.GetFullPath("VanThanh\\CustomMocNap.ini"));
}

void CMocNap::MocNap1(LPOBJ lpObj)  // ok
{
	int SetMocNap1 = 0;
	if (lpObj->QUANAP.MOCNAPCOIN >= this->MocNapCheck1)
	{
...
{
	int SetMocNap2 = 0;
	if (lpObj->QUANAP.MOCNAPCOIN >= this->MocNapCheck2)
	{
...
{
	int SetMocNap3 = 0;
	if (lpObj->QUANAP.MOCNAPCOIN >= this->MocNapCheck3)
	{
...
{
	int SetMocNap4 = 0;
	if (lpObj->QUANAP.MOCNAPCOIN >= this->MocNapCheck4)
	{
...
{
	int regalo = 0;
	if (lpObj->QUANAP.MOCNAPCOIN >= this->MocNapCheck5)
	{
...
{
	int regalo = 0;
	if (lpObj->QUANAP.MOCNAPCOIN >= this->MocNapCheck6)
	{
...
{
	int regalo = 0;
	if (lpObj->QUANAP.MOCNAPCOIN >= this->MocNapCheck7)
	{
...
{
	int regalo = 0;
	if (lpObj->QUANAP.MOCNAPCOIN >= this->MocNapCheck8)
	{
...
{
	int regalo = 0;
	if (lpObj->QUANAP.MOCNAPCOIN >= this->MocNapCheck9)
	{
...
{
	int regalo = 0;
	if (lpObj->QUANAP.MOCNAPCOIN >= this->MocNapCheck10)
	{
...
{
	int regalo = 0;
	if (lpObj->QUANAP.MOCNAPCOIN >= this->MocNapCheck11)
	{
...
{
	int regalo = 0;
	if (lpObj->QUANAP.MOCNAPCOIN >= this->MocNapCheck12)
	{
...
{
	int regalo = 0;
	if (lpObj->QUANAP.MOCNAPCOIN >= this->MocNapCheck13)
	{
