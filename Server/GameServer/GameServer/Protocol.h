...
void CGRegistroMainRecv(PMSG_REGISTER_ACCOUNT_RECV* lpMsg, int aIndex);
#endif

#if(DKTK2 == 1)
struct PMSG_REGISTER_MAIN_RECV
{
	PSBMSG_HEAD header; // C3:F1:01
	char account[10];
	char password[10];
...
void CGRegistroMainRecv(PMSG_REGISTER_MAIN_RECV* lpMsg, int aIndex);
#endif
