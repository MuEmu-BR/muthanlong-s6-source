...
void ProtocolCore(BYTE head,BYTE* lpMsg,int size,int aIndex,int encrypt,int serial) // OK
{
...
#if(DKTK1 == 1)	
	if (lpMsg[0] == 0xC1 && head == 0xFB)
	{
		if (lpMsg[3] == 0x82)
		{
			CGRegistroMainRecv((PMSG_REGISTER_ACCOUNT_RECV*)lpMsg, aIndex);
			return;
		}				
	}
#endif
	...
	{		
		...
		case 0x18:
			gCommandManager.RecvZenCustomVault(&gObj[aIndex], "");
			break;
		case 0x19:
			gCommandManager.SendZenCustomVault(&gObj[aIndex], "");
			break;
			//
		case 0x30:
			gCommandManager.RecvChaosCustomVault(&gObj[aIndex], "");
			break;
		case 0x31:
			gCommandManager.RecvChaosCustomVault10(&gObj[aIndex], "");
			break;
		case 0x12:
			gCommandManager.RecvChaosCustomVault20(&gObj[aIndex], "");
			break;
		case 0x13:
			gCommandManager.RecvChaosCustomVault30(&gObj[aIndex], "");
			break;

		case 0x14:
			gCommandManager.RecvBlessCustomVault(&gObj[aIndex], "");
			break;
		case 0x15:
			gCommandManager.RecvBlessCustomVault10(&gObj[aIndex], "");
			break;
		case 0x36:
			gCommandManager.RecvBlessCustomVault20(&gObj[aIndex], "");
			break;
		case 0x17:
			gCommandManager.RecvBlessCustomVault30(&gObj[aIndex], "");
			break;

		case 0x28:
			gCommandManager.RecvSoulCustomVault(&gObj[aIndex], "");
			break;
		case 0x39:
			gCommandManager.RecvSoulCustomVault10(&gObj[aIndex], "");
			break;
		case 0x40:
			gCommandManager.RecvSoulCustomVault20(&gObj[aIndex], "");
			break;
		case 0x41:
			gCommandManager.RecvSoulCustomVault30(&gObj[aIndex], "");
			break;

		case 0x42:
			gCommandManager.RecvLifeCustomVault(&gObj[aIndex], "");
			break;
		case 0x43:
			gCommandManager.RecvLifeCustomVault10(&gObj[aIndex], "");
			break;
		case 0x44:
			gCommandManager.RecvLifeCustomVault20(&gObj[aIndex], "");
			break;
		case 0x45:
			gCommandManager.RecvLifeCustomVault30(&gObj[aIndex], "");
			break;

		case 0x46:
			gCommandManager.RecvCreCustomVault(&gObj[aIndex], "");
			break;
		case 0x47:
			gCommandManager.RecvCreCustomVault10(&gObj[aIndex], "");
			break;
		case 0x48:
			gCommandManager.RecvCreCustomVault20(&gObj[aIndex], "");
			break;
		case 0x49:
			gCommandManager.RecvCreCustomVault30(&gObj[aIndex], "");
			break;

		case 0x50:
			gCommandManager.RecvGemCustomVault(&gObj[aIndex], "");
			break;
		case 0x51:
			gCommandManager.RecvGemCustomVault10(&gObj[aIndex], "");
			break;
		case 0x52:
			gCommandManager.RecvGemCustomVault20(&gObj[aIndex], "");
			break;
		case 0x53:
			gCommandManager.RecvGemCustomVault30(&gObj[aIndex], "");
			break;
			//--
		case 0x54:
			gCommandManager.SendChaosCustomVault(&gObj[aIndex], "");
			break;
		case 0x55:
			gCommandManager.SendBlessCustomVault(&gObj[aIndex], "");
			break;
		case 0x56:
			gCommandManager.SendSoulCustomVault(&gObj[aIndex], "");
			break;
		case 0x57:
			gCommandManager.SendLifeCustomVault(&gObj[aIndex], "");
			break;
		case 0x58:
			gCommandManager.SendCreCustomVault(&gObj[aIndex], "");
			break;
		case 0x59:
			gCommandManager.SendGemCustomVault(&gObj[aIndex], "");
			break;

		case 0x61:
			gCommandManager.SendGem1CustomVault(&gObj[aIndex], "");
			break;
		case 0x62:
			gCommandManager.SendGem2CustomVault(&gObj[aIndex], "");
			break;
		case 0x63:
			gCommandManager.SendGem3CustomVault(&gObj[aIndex], "");
			break;
		case 0x64:
			gCommandManager.SendGem4CustomVault(&gObj[aIndex], "");
			break;

		case 0x65:
			gCommandManager.RecvGem1CustomVault(&gObj[aIndex], "");
			break;
		case 0x66:
			gCommandManager.RecvGem1CustomVault10(&gObj[aIndex], "");
			break;
		case 0x67:
			gCommandManager.RecvGem1CustomVault20(&gObj[aIndex], "");
			break;
		case 0x68:
			gCommandManager.RecvGem1CustomVault30(&gObj[aIndex], "");
			break;
			//==
		case 0x69:
			gCommandManager.RecvGem2CustomVault(&gObj[aIndex], "");
			break;
		case 0x70:
			gCommandManager.RecvGem2CustomVault10(&gObj[aIndex], "");
			break;
		case 0x71:
			gCommandManager.RecvGem2CustomVault20(&gObj[aIndex], "");
			break;
		case 0x72:
			gCommandManager.RecvGem2CustomVault30(&gObj[aIndex], "");
			break;
		case 0x73:
			gCommandManager.RecvGem3CustomVault(&gObj[aIndex], "");
			break;
		case 0x74:
			gCommandManager.RecvGem3CustomVault10(&gObj[aIndex], "");
			break;
		case 0x75:
			gCommandManager.RecvGem3CustomVault20(&gObj[aIndex], "");
			break;
		case 0x76:
			gCommandManager.RecvGem3CustomVault30(&gObj[aIndex], "");
			break;
		case 0x77:
			gCommandManager.RecvGem4CustomVault(&gObj[aIndex], "");
			break;
		case 0x78:
			gCommandManager.RecvGem4CustomVault10(&gObj[aIndex], "");
			break;
		case 0x79:
			gCommandManager.RecvGem4CustomVault20(&gObj[aIndex], "");
			break;
		case 0x80:
			gCommandManager.RecvGem4CustomVault30(&gObj[aIndex], "");
			break;
#endif
		...
		case 0x81:
		{
			LogAdd(LOG_RED, "Fix Dupe WareHouser");
	...
	switch(head)
	{
		...
		case 0x1C:
			...
			break;
		case 0x1E: // 1 lan dump nhay den day
...
#if(DKTK2 == 1)
				case 0x100: //add
					CGRegistroMainRecv((PMSG_REGISTER_MAIN_RECV*)lpMsg, aIndex);
					break;
#endif
		...
		case 0xFC:
...
#if(KINHMACH_NEW == 1)
			case 0x06:
				gKinhMach.BUG_KINHMACH(lpObj, (BUY_KINHMACH_REQ*)lpMsg);
				break;
#endif
...
#if(TAISINH == 1)
			case 0x08:
				gTaiSinh.TAISINH_ATIVE(lpObj, (TAISINH_REQ*)lpMsg);
				break;
#endif
...
#if(PHUKIEN_NEW == 1)
			case 0x10:
				gPhuKien.BUG_PHUKIEN(lpObj, (BUY_PHUKIEN_REQ*)lpMsg);
				break;
#endif
				//--------------------------------------
#if(MOVE_EVENT_NEW == 1)
			...
			case 0x20:
				gPartySearch.GCPartyListSend(lpObj->Index);
				break;
		...
		case 0x80:
			...
			{
			case 0x00:
				g_ChoTroi.CGReqItemList((PMSG_REQ_MARKET_ITEM*)lpMsg, aIndex);
				break;
			case 0x01:
				g_ChoTroi.CGReqItemSell((PMSG_REQ_MARKET_SELL*)lpMsg, aIndex);
				break;
			case 0x02:
				g_ChoTroi.CGReqItemBuy((PMSG_REQ_MARKET_BUY*)lpMsg, aIndex);
				break;
			}
			break;
#endif
		...
		case 0xFD:
			...
			case 0x21:
				...
				break;
			case 0x22:
				gRanking.SendUserDW(lpObj);
				break;
			case 0x23:
				gRanking.SendUserDK(lpObj);
				break;
			case 0x24:
				gRanking.SendUserEF(lpObj);
				break;
			case 0x25:
				gRanking.SendUserMG(lpObj);
				break;
			case 0x26:
				gRanking.SendUserDL(lpObj);
				break;
			case 0x27:
				gRanking.SendUserSM(lpObj);
				break;
			case 0x28:
				gRanking.SendUserRF(lpObj);
				break;
			case 0x29:
				gRanking.SendUserNAP(lpObj);
				break;
			case 0x30:
				gRanking.SendUserBLOOD(lpObj);
				break;
			case 0x31:
				gRanking.SendUserDEVIL(lpObj);
				break;
			case 0x32:
				gRanking.SendUserCHAOS(lpObj);
				break;
#endif
...
void GCAutoMove(AUTOMOVE_REQ* lpMsg, int aIndex) {
	...
	LogAdd(LOG_RED, "Set Move IsAutoMoveRunning %d , %s", lpObj->IsAutoMoveRunning, lpObj->Name);
...
void GCNewHealthBarSend(LPOBJ lpObj) // OK
{
	...
	for (int n = 0; n < MAX_VIEWPORT; n++)
	{
		...
		info.rate = (BYTE)((lpTarget->Life * 100) / (lpTarget->MaxLife + lpTarget->AddLife));
		 ...
		 //==soiitem , test thử soi vũ khí nhé
		...
		if (lpObj->VpPlayer[n].type == OBJECT_USER)
		{
			...
			for (size_t i = 0; i < 2; i++)
			{
				...
				//	lpTarget->Inventory[i].m_Index == GET_ITEM(13, 20) && lpTarget->Inventory[i].m_Level == 3)
				//-----
				if (lpTarget->Inventory[i].IsItem() && lpTarget->Inventory[i].m_Index == GET_ITEM(0, 51))
				{
					bHas = true;
					break;
				}
				//-----
				if (lpTarget->Inventory[i].IsItem() && lpTarget->Inventory[i].m_Index == GET_ITEM(0, 53))
				{
					bHas = true;
					break;
				}
				//-----
				if (lpTarget->Inventory[i].IsItem() && lpTarget->Inventory[i].m_Index == GET_ITEM(0, 106))
				{
					bHas = true;
					break;
				}
				//-----
				if (lpTarget->Inventory[i].IsItem() && lpTarget->Inventory[i].m_Index == GET_ITEM(2, 25))
				{
					bHas = true;
					break;
				}
				//-----
				if (lpTarget->Inventory[i].IsItem() && lpTarget->Inventory[i].m_Index == GET_ITEM(4, 30))
				{
					bHas = true;
					break;
				}
				//-----
				if (lpTarget->Inventory[i].IsItem() && lpTarget->Inventory[i].m_Index == GET_ITEM(4, 33))
				{
					bHas = true;
					break;
				}
				//-----
				if (lpTarget->Inventory[i].IsItem() && lpTarget->Inventory[i].m_Index == GET_ITEM(5, 49))
				{
					bHas = true;
					break;
				}
				//-----
				if (lpTarget->Inventory[i].IsItem() && lpTarget->Inventory[i].m_Index == GET_ITEM(5, 50))
				{
					bHas = true;
					break;
				}
...
//=====================================================================
#if(KINHMACH_NEW == 1)
void GetInfoKinhMach(LPOBJ lpObj)
{
	PMSG_KINHMACH_UPD pMsg;
	pMsg.h.set(0xFB, 0x36, sizeof(pMsg)); // Gửi Lên Client Protocol.cpp
	pMsg.KINHMACH1 = lpObj->KINHMACH.KINHMACH1;
	pMsg.KINHMACH2 = lpObj->KINHMACH.KINHMACH2;
	pMsg.KINHMACH3 = lpObj->KINHMACH.KINHMACH3;
	pMsg.KINHMACH4 = lpObj->KINHMACH.KINHMACH4;
	pMsg.KINHMACH5 = lpObj->KINHMACH.KINHMACH5;
	pMsg.KINHMACH6 = lpObj->KINHMACH.KINHMACH6;
	pMsg.KINHMACH7 = lpObj->KINHMACH.KINHMACH7;
	pMsg.KINHMACH8 = lpObj->KINHMACH.KINHMACH8;
	pMsg.KINHMACHSD = lpObj->KINHMACH.KINHMACHSD;
	pMsg.KINHMACHHP = lpObj->KINHMACH.KINHMACHHP;
	DataSend(lpObj->Index, (BYTE*)&pMsg, sizeof(pMsg));
}
void GetInfoKinhMachLevel(LPOBJ lpObj)
{
	PMSG_KINHMACH_LEVEL_UPD pMsg;
	pMsg.h.set(0xFB, 0x37, sizeof(pMsg)); // Gửi Lên Client Protocol.cpp
	// ----
	pMsg.MAX_KINH_MACH_01 = gKinhMach.MAX_KINH_MACH_01;
	pMsg.MAX_KINH_MACH_02 = gKinhMach.MAX_KINH_MACH_02;
	pMsg.MAX_KINH_MACH_03 = gKinhMach.MAX_KINH_MACH_03;
	pMsg.MAX_KINH_MACH_04 = gKinhMach.MAX_KINH_MACH_04;
	pMsg.MAX_KINH_MACH_05 = gKinhMach.MAX_KINH_MACH_05;
	pMsg.MAX_KINH_MACH_06 = gKinhMach.MAX_KINH_MACH_06;
	pMsg.MAX_KINH_MACH_07 = gKinhMach.MAX_KINH_MACH_07;
	pMsg.MAX_KINH_MACH_08 = gKinhMach.MAX_KINH_MACH_08;
...
void GetInfoClient(LPOBJ lpObj)
{
	...
	pMsg.SachThuocTinh_01 = lpObj->SACHTHUOCTINH.SACHTHUOCTINH_01;
#if(PHUKIEN_NEW == 1)
	pMsg.PHUKIEN1 = lpObj->PHUKIEN.PHUKIEN1;
	pMsg.PHUKIEN2 = lpObj->PHUKIEN.PHUKIEN2;
#endif
...
#if(MOCNAP == 1)
	pMsg.MOCNAPCOIN = lpObj->QUANAP.MOCNAPCOIN;
#endif
	pMsg.Money = lpObj->Money;
	DataSend(lpObj->Index, (BYTE*)&pMsg, sizeof(pMsg));
}
...
void CGRegistroMainRecv(PMSG_REGISTER_ACCOUNT_RECV* lpMsg, int aIndex) // OK
{
	LogAdd(LOG_RED, "[Dang Ky] %s, %s, %s",
		lpMsg->account,
		lpMsg->password,
		//lpMsg->name,
		//lpMsg->phone,
	...
	GJRegistroMainSend(account, password, numcode);
}
#endif

#if(DKTK2 == 1)
void CGRegistroMainRecv(PMSG_REGISTER_MAIN_RECV* lpMsg, int aIndex) // OK
{
