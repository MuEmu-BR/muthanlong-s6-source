...
void DGGuildScoreUpdate1(LPSTR guildname, int score1)
{
	SDHP_GUILDSCOREUPDATE1 pMsg;

	pMsg.h.set(0x39, sizeof(SDHP_GUILDSCOREUPDATE1));
	pMsg.Score1 = score1;
	memcpy(pMsg.GuildName, guildname, sizeof(pMsg.GuildName));
...
void GDGuildScoreUpdateRecv1(SDHP_GUILDSCOREUPDATE1 * lpMsg)
{
	GUILD_INFO_STRUCT * lpNode = gGuildClass.SearchGuild(lpMsg->GuildName);
	...
	lpNode->TotalScore1 = lpMsg->Score1;
}
#endif
