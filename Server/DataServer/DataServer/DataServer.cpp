...
int RunSaveChienTruongCo;
int RunSaveChienTruongCoNgay;
...
int APIENTRY WinMain(HINSTANCE hInstance,HINSTANCE hPrevInstance,LPSTR lpCmdLine,int nCmdShow) // OK
{
	...
	if(WSAStartup(MAKEWORD(2,2),&wsa) == 0)
	{
		...
		RunSaveChienTruongCo = GetPrivateProfileInt("DataServerInfo", "RunSaveChienTruongCo", 0, ".\\DataServer.ini");
		RunSaveChienTruongCoNgay = GetPrivateProfileInt("DataServerInfo", "RunSaveChienTruongCoNgay", 0, ".\\DataServer.ini");
