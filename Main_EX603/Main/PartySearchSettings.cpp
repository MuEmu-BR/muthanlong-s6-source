...
void cPartySearchSettings::draw_party_settings_window()
{
	...
	//gCItemSetOption.ItemTooltipS15(StartX , StartY - 340, 223, 370, 0.0, 0);
	gCentral.PrintDropBox(StartX, StartY - 340, 225, 370, 0, 0);
	...
	// ----
	gInterface.DrawText(eGold, StartX + 10, 33, 210, 3, "Cài đặt tạo nhóm");
	///////////////////////////////////////////ACTIVE SYSTEM///////////////////////////////////////////
	gInterface.DrawText(eWhite, StartX + 40, gInterface.Data[OBJECT_PARTYSETTINGS_MAIN].Y + 33, 200, 1, "Kích hoạt");
	...
	gInterface.DrawGUI(OBJECT_PARTYSETTINGS_DIV, StartX, gInterface.Data[OBJECT_PARTYSETTINGS_MAIN].Y + 40); // Äåëèòåëü áîëüøîé
	/////////////////////////////////////////ACTIVE SYSTEM END/////////////////////////////////////////

	/////////////////////////////////////////////MAX LEVEL/////////////////////////////////////////////
	gInterface.DrawText(eWhite, StartX + 40, gInterface.Data[OBJECT_PARTYSETTINGS_MAIN].Y + 60, 200, 1, "Max Level");
	//gInterface.DrawGUI(OBJECT_PARTYSETTINGS_DIV, StartX , gInterface.Data[OBJECT_PARTYSETTINGS_MAIN].Y + 67); // Äåëèòåëü áîëüøîé
	pDrawGUI(0x7B5E, StartX + 30, gInterface.Data[OBJECT_PARTYSETTINGS_MAIN].Y + 73, 82.0, 2.0); // Äåëèòåëü ìåëêèé 1
	pDrawGUI(0x7B5E, StartX + 30 + 82, gInterface.Data[OBJECT_PARTYSETTINGS_MAIN].Y + 73, 82.0, 2.0); // Äåëèòåëü ìåëêèé 2
	...
	gInterface.DrawText(eWhite, StartX + 40, gInterface.Data[OBJECT_PARTYSETTINGS_MAIN].Y + 82, 200, 1, "Mật khẩu");
	...
	pDrawGUI(0x7B5E, StartX + 30, gInterface.Data[OBJECT_PARTYSETTINGS_MAIN].Y + 95, 82.0, 2.0); // Äåëèòåëü ìåëêèé 1
	pDrawGUI(0x7B5E, StartX + 30 + 82, gInterface.Data[OBJECT_PARTYSETTINGS_MAIN].Y + 95, 82.0, 2.0); // Äåëèòåëü ìåëêèé 2
	...
	pDrawGUI(0x7B5E, StartX + 30, gInterface.Data[OBJECT_PARTYSETTINGS_MAIN].Y + /*100*/117, 82.0, 2.0); // Äåëèòåëü ìåëêèé 1
	pDrawGUI(0x7B5E, StartX + 30 + 82, gInterface.Data[OBJECT_PARTYSETTINGS_MAIN].Y + 117, 82.0, 2.0); // Äåëèòåëü ìåëêèé 2
	...
	pDrawGUI(0x7B5E, StartX + 30, gInterface.Data[OBJECT_PARTYSETTINGS_MAIN].Y + 139, 82.0, 2.0); // Äåëèòåëü ìåëêèé 1
	pDrawGUI(0x7B5E, StartX + 30 + 82, gInterface.Data[OBJECT_PARTYSETTINGS_MAIN].Y + 139, 82.0, 2.0); // Äåëèòåëü ìåëêèé 2
	...
	gInterface.DrawGUI(OBJECT_PARTYSETTINGS_DIV, StartX, gInterface.Data[OBJECT_PARTYSETTINGS_MAIN].Y + 154);// 94 // Äåëèòåëü áîëüøîé
	/////////////////////////////////////////////GUILD END/////////////////////////////////////////////
	...
	for (int i = 0; i < 7; i++)
	{
		...
		if (i != 0)
		{
			pDrawGUI(0x7B5E, StartX + 30, gInterface.Data[OBJECT_PARTYSETTINGS_MAIN].Y + 148 + 17 + (i * 22), 82.0, 2.0); // Äåëèòåëü ìåëêèé 1
			pDrawGUI(0x7B5E, StartX + 30 + 82, gInterface.Data[OBJECT_PARTYSETTINGS_MAIN].Y + 148 + 17 + (i * 22), 82.0, 2.0); // Äåëèòåëü ìåëêèé 2
		}
	}

	gInterface.DrawGUI(OBJECT_PARTYSETTINGS_DIV, StartX, gInterface.Data[OBJECT_PARTYSETTINGS_MAIN].Y + 295 + 17); // Äåëèòåëü áîëüøîé
