...
void CLuckySpin::Draw()
{
	...
	gCentral.PrintDropBox(StartX - 55, gInterface.Data[eLuckySpin].Y + 60, 300, 290, 0.0, 0);

	//--------------------------------------------------------------------------------------------
	gInterface.DrawFormat(eWhite, 200, 71, 210, 3, gOther.TextVN[5]); // "Vòng Quay May Mắn"
	//--------------------------------------------------------------------------------------------
	//
	...
	//--------------------------------------------------------------------------------------------
	gInterface.DrawFormat(eWhite, 200, 170, 210, 3, gOther.TextVN[6]); // "Phần thưởng"
	//--------------------------------------------------------------------------------------------
	//
	// item nhận thưởng
	if (this->RollNumber >= 0)
	...
	//--------------------------------------------------------------------------------------------
	gInterface.DrawFormat(eYellow, 200, 222, 210, 3, gOther.TextVN[7],this->WCoinC); // "Giá"
	//--------------------------------------------------------------------------------------------
	gInterface.DrawFormat(eYellow, 200, 247, 210, 3, gOther.TextVN[8]); // "Quay"
	//--------------------------------------------------------------------------------------------
	//
