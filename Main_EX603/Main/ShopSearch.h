...
public:
	...
	void		OPEN_WINDOW_STORE() { gInterface.Data[ePT_PERSONAL_SEARCH_MAIN].OnShow = true; pSetCursorFocus = true; };
	void		CLOSE_WINDOW_STORE() { gInterface.Data[ePT_PERSONAL_SEARCH_MAIN].OnShow = false; pSetCursorFocus = false; };
	bool		CHECK_WINDOW_STORE() { return gInterface.Data[ePT_PERSONAL_SEARCH_MAIN].OnShow; };
