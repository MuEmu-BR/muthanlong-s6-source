	...
	if (this->JewelEnable == 1)
	{
		...
		for (int i = (5 * this->Page); i < (5 * this->Page) + 5; i++)
		{
			...
			if (i == 5)
			{
				...
				gInterface.DrawFormat(eGold, StartX + 35, StartBody + 57 + (36 * posyy), 60, 1, gCustomMessage.GetMessage(30));
		...
		gInterface.DrawFormat(eExcellent, StartX, StartBody + 240, 230, 3, gCustomMessage.GetMessage(31));
	}
	else
	{
		if (this->Loading == 1)
