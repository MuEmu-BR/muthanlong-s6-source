...
void CAchievements::BindImages()
{
	...
	gInterface.BindObject(OBJECT_ACHIEVEMENTS_MAIN, 31461, 900, 1000, -1, -1);
...
void CAchievements::Draw()
{
	...
	gCItemSetOption.ItemTooltipS15(5, 20, 630, 405, 0.0, 150);
	//gCItemSetOption.ItemTooltipS15(5, 20, 630, 405, 0.0, 150);


	gInterface.DrawText(eGold, MAX_WIN_WIDTH / 2, 23, 0, eCenter, "Hệ thống Thành Tựu");

	gInterface.DrawGUI(OBJECT_ACHIEVEMENTS_CLOSE, 630 + 10 - gInterface.Data[OBJECT_ACHIEVEMENTS_CLOSE].Width, gInterface.Data[OBJECT_ACHIEVEMENTS_CLOSE].Height + gInterface.Data[OBJECT_ACHIEVEMENTS_CLOSE].Height - 40);
	// ----
