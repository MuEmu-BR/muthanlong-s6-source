...
#define pWzAudioPlay			((void(__cdecl*)(PCHAR, int))0x4CF050)
#define pLoadGameStuffs			((void(__cdecl*)(HDC))0x4D9CF0)
//-- Control Interface
...
#define pDrawButtonDynamic			((void(__cdecl*)(DWORD, float, float, float, float, float, float)) 0x00790E40)
...
///--
// DEV_PLAYERSHOP
#define pSetItemOption2			((void(__cdecl*)(ObjectItem * lpItem, BYTE Option, BYTE Special, BYTE Value)) 0x58B910)
