...
public:
	...
	void SwitchStatsWindowState() { (gInterface.Data[OBJECT_WIN_QUEST_MAIN].OnShow == true) ? gInterface.Data[OBJECT_WIN_QUEST_MAIN].CloseAnimated(15) : gInterface.Data[OBJECT_WIN_QUEST_MAIN].Open(-226, 20); };
	int OpenTab;
