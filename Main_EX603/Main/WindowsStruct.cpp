...
void LoadWindows(DWORD id, float x, float y, float w, float h)
{
	...
	RenderBitmap(61536, x, y, w, h, 0.0, 0.0, 0.6245000958, 0.6245000958, 0, 0, 0);
}
...
void PetMuunHP(signed int x, signed int y, int nameIndex, signed int hp, signed int hpmax, char a9)
{
	...
	if( MinimizarPet == 0 )
	{
		RenderBitmap(61545, 1, y + 22, Return2X(TransForX( 74 )), ReturnY(TransForY( 24 )), 0.0, 0.1731800437, 0.75, 0.2378999293,1, 1, 0); //-- Fondo
...
void PrintAdvanceStatus(int x, int y)
{
	...
	v6 = 11;
	Width = 115;
	gInterface.DrawFormat(eShinyGreen, x + 8, 56, 170, 1, "Thông tin nhân vật");
	...
	pSetTextColor(pTextThis(), 0xFFu, 0xFFu, 0xFFu, 0xFFu);
	v5 = y + 80; //-- 1
	SetPrintf("· Tổng phản sát thương", x, v5, Width, 1);
	v5+= v6; //-- 2
	SetPrintf("· Tỷ lệ phản sát thương đầy đủ", x, v5, Width, 1);
	v5+= v6; //-- 3
	...
	v5+= v6; //-- 6
	SetPrintf("· Tỷ lệ sát thương hoàn hảo", x, v5, Width, 1);
	v5+= v6; //-- 7
	pDrawText(pTextThis(), x, v5, "· Sát thương hoàn hảo (PVM)", Width, 0, (LPINT)1, 0);
	v5+= v6; //-- 8
	pDrawText(pTextThis(), x, v5, "· Sát thương hoàn hảo (PVP)", Width, 0, (LPINT)1, 0);
	v5+= v6; //-- 9
	pDrawText(pTextThis(), x, v5, "· Tỷ lệ x2 sát thương", Width, 0, (LPINT)1, 0);
	v5+= v6; //-- 10
	pDrawText(pTextThis(), x, v5, "· Tỷ lệ x3 sát thương:", Width, 0, (LPINT)1, 0);
	v5+= v6; //-- 11
	pDrawText(pTextThis(), x, v5, "· Tỷ lệ giảm sát thương", Width, 0, (LPINT)1, 0);
	v5+= v6; //-- 12
	pDrawText(pTextThis(), x, v5, "· Shield Skill Dmg Redc Rate", Width, 0, (LPINT)1, 0);
	v5+= v6; //-- 13
	pDrawText(pTextThis(), x, v5, "· Tỷ lệ giảm sát thương SD", Width, 0, (LPINT)1, 0);
	v5+= v6; //-- 14
	pDrawText(pTextThis(), x, v5, "· SD giảm tỷ lệ sát thương", Width, 0, (LPINT)1, 0);
	v5+= v6; //-- 15
	pDrawText(pTextThis(), x, v5, "· Bỏ qua tỷ lệ phòng thủ", Width, 0, (LPINT)1, 0);
	v5+= v6; //-- 16
	pDrawText(pTextThis(), x, v5, "· Bỏ qua tỷ lệ SD", Width, 0, (LPINT)1, 0);
	v5+= v6; //-- 17
...
void CharacterInfoWindow(int a1)
{
	...
	*(signed int *)(This + 16) = 1;
	...
	pSetTextColor(pTextThis(), 0xFFu, 0xFFu, 0xFFu, 0xFFu);
	ZeroMemory(v10, sizeof(v10));
	wsprintf(v10, pGetTextLine(pTextLineThis, 1745)); // Master
	...
	pDrawText(pTextThis(), x + 120, y + 143, v10, 90, 0, (LPINT)1, 0);
	...
	pDrawText(pTextThis(), x + 120, y + 154, v10, 90, 0, (LPINT)1, 0);
...
//=============================
	...
	*(DWORD *)(MainSlot + 40) = Return2X(x + (Width / 2) - TransFor2X(t / 2));
		...
		&& (signed int)(unsigned __int8)SetOption2((int) pUserStat()) <= 0 )
	{
		...
		RenderBitmap(61535, Return2X(x + TransForX(10)), ReturnY(TransForY(194)), Return2X(TransForX(43)), ReturnY(TransForY(17)), 0.0, 0.2235384732, 0.5035384717, 0.2215384692, 1, 1, 0);
	}
	else
	{
		pSetTextColor(pTextThis(), 0xFFu, 0xFFu, 0xFFu, 0xFFu);
		RenderBitmap(61535, Return2X(x + TransForX(10)), ReturnY(TransForY(194)), Return2X(TransForX(43)), ReturnY(TransForY(17)), 0.0, 0.0, 0.5035384717, 0.2215384692, 1, 1, 0);
	}
	ZeroMemory(v10, sizeof(v10));
	wsprintf(v10, pGetTextLine(pTextLineThis, 3363)); //-- Đồ Thần
	pDrawText(pTextThis(), Return2X(x + TransForX(10)), ReturnY(y + TransForY(198)), v10, Return2X(TransForX(43)), 0, (LPINT)3, 0);
	...
	if (gProtect.m_MainInfo.DisableSocketInvetori == 1)
	{
		...
		{
			pSetTextColor(pTextThis(), 0x64u, 0x64u, 0x64u, 0xFFu);
			RenderBitmap(61535, Return2X(x + TransForX(10)), ReturnY(y + TransForY(215)), Return2X(TransForX(43)), ReturnY(TransForY(17)), 0.0, 0.2235384732, 0.5035384717, 0.2215384692, 1, 1, 0);
		}
		else
		{
			pSetTextColor(pTextThis(), 0xFFu, 0xFFu, 0xFFu, 0xFFu);
			RenderBitmap(61535, Return2X(x + TransForX(10)), ReturnY(y + TransForY(215)), Return2X(TransForX(43)), ReturnY(TransForY(17)), 0.0, 0.0, 0.5035384717, 0.2215384692, 1, 1, 0);
		}
		ZeroMemory(v10, sizeof(v10));
		wsprintf(v10, pGetTextLine(pTextLineThis, 2650)); //-- Socket
		pDrawText(pTextThis(), Return2X(x + TransForX(10)), ReturnY(y + TransForY(218)), v10, Return2X(TransForX(43)), 0, (LPINT)3, 0);
	}

	//-- Repair
	ChangeButtonInfo((char *)(This + 288), Return2X(x + TransForX(54)), ReturnY(TransForY(215)), Return2X(TransForX(43)), ReturnY(TransForY(17)));
	if( *(WORD *)(*(DWORD*)0x8128AC8 + 14) >= 50 && !pCheckWindow(pWindowThis(), Warehouse) )
	{
		if (CheckButtonPressed(Return2X(x + TransForX(54)), ReturnY(TransForY(215)), Return2X(TransForX(43)), ReturnY(TransForY(17))))
		{
			RenderBitmap(61535, Return2X(x + TransForX(54)), ReturnY(TransForY(215)), Return2X(TransForX(43)), ReturnY(TransForY(17)), 0.0, 0.2235384732, 0.5035384717, 0.2215384692, 1, 1, 0);
		}
		else
		{
			...
			{
				RenderBitmap(61535, Return2X(x + TransForX(54)), ReturnY(TransForY(215)), Return2X(TransForX(43)), ReturnY(TransForY(17)), 0.0, 0.0, 0.5035384717, 0.2215384692, 1, 1, 0);
			}
		}
		pSetTextColor(pTextThis(), 0xFFu, 0xFFu, 0xFFu, 0xFFu);
	}//-- over 0.4460069239
	...
	{
		RenderBitmap(61535, Return2X(x + TransForX(54)), ReturnY(TransForY(215)), Return2X(TransForX(43)), ReturnY(TransForY(17)), 0.0, 0.6706154196, 0.5035384717, 0.2215384692, 1, 1, 0);
		pSetTextColor(pTextThis(), 0x64u, 0x64u, 0x64u, 0xFFu);
	}
	ZeroMemory(v10, sizeof(v10));
	wsprintf(v10, pGetTextLine(pTextLineThis, 3364));// Sửa Chữa
	pDrawText(pTextThis(), Return2X(x + TransForX(54)), ReturnY(TransForY(218)), v10, Return2X(TransForX(43)), 0, (LPINT)3, 0);

	//-- store
	ChangeButtonInfo((char *)(This + 632), Return2X(x + TransForX(90)), ReturnY(TransForY(380)), Return2X(TransForX(43)), ReturnY(TransForY(17)));
	...
	{
		RenderBitmap(61535, Return2X(x + TransForX(90)), ReturnY(TransForY(380)), Return2X(TransForX(43)), ReturnY(TransForY(17)), 0.0, 0.6706154196, 0.5035384717, 0.2215384692, 1, 1, 0);
		pSetTextColor(pTextThis(), 0x64u, 0x64u, 0x64u, 0xFFu);
	}
	else
	{
		if (CheckButtonPressed(Return2X(x + TransForX(90)), ReturnY(TransForY(380)), Return2X(TransForX(43)), ReturnY(TransForY(17))) || pCheckWindow(pWindowThis(), Store))
		{
			RenderBitmap(61535, Return2X(x + TransForX(90)), ReturnY(TransForY(380)), Return2X(TransForX(43)), ReturnY(TransForY(17)), 0.0, 0.2235384732, 0.5035384717, 0.2215384692, 1, 1, 0);
		}
		else
		{
			RenderBitmap(61535, Return2X(x + TransForX(90)), ReturnY(TransForY(380)), Return2X(TransForX(43)), ReturnY(TransForY(17)), 0.0, 0.0, 0.5035384717, 0.2215384692, 1, 1, 0);
		}//-- over 0.4460069239
		pSetTextColor(pTextThis(), 0xFFu, 0xFFu, 0xFFu, 0xFFu);
	}
	ZeroMemory(v10, sizeof(v10));
	wsprintf(v10, pGetTextLine(pTextLineThis, 3365)); // Cửa hàng
	pDrawText(pTextThis(), Return2X(x + TransForX(90)), ReturnY(TransForY(383)), v10, Return2X(TransForX(43)), 0, (LPINT)3, 0);

	//-- Inv Ext
	ChangeButtonInfo((char *)(This + 804), Return2X(x + TransForX(135)), ReturnY(TransForY(380)), Return2X(TransForX(43)), ReturnY(TransForY(17)));
	
	if (CheckButtonPressed(Return2X(x + TransForX(135)), ReturnY(TransForY(380)), Return2X(TransForX(43)), ReturnY(TransForY(17))) || pCheckWindow(pWindowThis(), ExpandInventory))
	{
		RenderBitmap(61535, Return2X(x + TransForX(135)), ReturnY(TransForY(380)), Return2X(TransForX(43)), ReturnY(TransForY(17)), 0.0, 0.2235384732, 0.5035384717, 0.2215384692, 1, 1, 0);
	}
	else
	{
		RenderBitmap(61535, Return2X(x + TransForX(135)), ReturnY(TransForY(380)), Return2X(TransForX(43)), ReturnY(TransForY(17)), 0.0, 0.0, 0.5035384717, 0.2215384692, 1, 1, 0);
	}//-- over 0.4460069239
	pSetTextColor(pTextThis(), 0xFFu, 0xFFu, 0xFFu, 0xFFu);
	ZeroMemory(v10, sizeof(v10));
	wsprintf(v10, pGetTextLine(pTextLineThis, 3366)); // Thùng đồ
	pDrawText(pTextThis(), Return2X(x + TransForX(135)), ReturnY(TransForY(383)), v10, Return2X(TransForX(43)), 0, (LPINT)3, 0);
	...
	//-- Gobil Coin
	ZeroMemory(v22, sizeof(v22));
	pGetMoneyFormat(Coin3, v22, 0);
	v15 = ColorMoney(Coin3);
	SetTextColorByHDC(pTextThis(), v15);
	pDrawText(pTextThis(), Return2X(x + TransForX(27 + 85)), ReturnY(TransForY(399)), v22, Return2X(TransForX(60)), 0, (LPINT)4, 0);


#if(CHARACTER_NEW)
	gInterface.DrawCharacterWindow();
	gInterface.DrawTinhNangWinDow();
#endif
#if(SACHTHUOCTINH_NEW)
	gInterface.DrawSachThuocTinhInterface();
	gInterface.DrawSachThuocTinh();
#endif
	...
	//g_MuunSystem.InventoryCtrlRender3D();
...
void WindowsInfoWareHouse(int a1)
{
	...
	*(signed int *)(This + 16) = 1;
	...
	if ( *(DWORD *)(This + 540) )
	{
		...
		*(DWORD *)((*(DWORD *)(This + 540)) + 40) = x + 28; //Return2X(( Width / 2 ) - TransForX( t ));
	}
...
void WindowsInfoWareHouseExt(int a1)
{
	...
	*(signed int *)(This + 16) = Return2X(TransForX( 190 ) );
	...
	if ( *(DWORD *)(v6 + 544) )
	{
		...
		*(DWORD *)((*(DWORD *)(v6 + 544)) + 40) = + 218;//Return2X(x + ( Width / 2 ) - TransForX( t ));
	}
...
void WindowsChaosBox(int index, float x, float y, float w, float h)
{
	...
	char v7[256]; // al@4
	int Color; // ST18_4@2
	int Width = TransForX( 215 ); // 255
	int Heigth = TransForY( 429 );
	This = GetChaosBox(GetInstance());

	if( pCheckWindow(pWindowThis(), 77) )
	{
		*(signed int *)(This + 20) = Return2X(TransFor2X(693) - (Width * 3));
	}
	else
	{
		*(signed int *)(This + 20) = Return2X(TransFor2X(693) - (Width * 2));
	}

	x = TransFor2X((double)*(signed int *)(This + 20));
	y = TransForY((double)*(signed int *)(This + 24));

	RenderBitmap(61558, x, y, Width, Heigth, 0.0, 0.0, 0.6245000958, 0.6245000958, 0, 0, 0);
	...
	ChangeButtonInfo((char *)(This + 28), Return2X(x + TransForX(102)), ReturnY(TransForY(387)), Return2X(TransForX(43)), ReturnY(TransForY(17)));

	if( CheckButtonPressed(Return2X(x + TransForX(102)), ReturnY(TransForY(387)), Return2X(TransForX(43)), ReturnY(TransForY(17))) )
	{
		RenderBitmap(61542, Return2X(x + TransForX(102)), ReturnY(TransForY(387)), Return2X(TransForX(43)), ReturnY(TransForY(17)), 0.0, 0.268338412, 0.7135385275, 0.2283384204, 1, 1, 0);
	}
	else
	{
		RenderBitmap(61542, Return2X(x + TransForX(102)), ReturnY(TransForY(387)), Return2X(TransForX(43)), ReturnY(TransForY(17)), 0.0, 0.02, 0.7135385275, 0.2283384204, 1, 1, 0);
	}
	pSetFont(pTextThis(), (int)*(HGDIOBJ*)0xE8C58C);
	pSetBackgroundTextColor(pTextThis(), 0, 0, 0, 0);
	...
	pDrawText(pTextThis(), Return2X(x + TransForX(102)), ReturnY(TransForY(390)), v7, Return2X(TransForX(43)), 0,(LPINT) 3, 0);
}
...
void RenderExpBar(int a1){
	...
	if ( pIsMaster(*(BYTE *)(*(DWORD *)0x7BC4F04 + 19)) == 1 ){
		...
		gInterface.DrawFormat(eWhite150, 92.0f , 473, 454, 3, "%I64u / %I64u", CurrentMasterExp, NextMasterExp);
	}else{
		ReadExp = *(WORD *)(*(DWORD *)0x8128AC8 + 0x10);
		ReadNextExp = *(DWORD *)(*(DWORD *)0x8128AC8 + 0x14);
		gInterface.DrawFormat(eWhite150, 92.0f , 473, 454, 3, "%d / %d", ReadExp, ReadNextExp);
	}
}
