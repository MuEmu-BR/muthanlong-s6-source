...
//--
	...
	pDrawText(pTextThis(), Return2X( XSDCoord + TransForX( 179.375 ) ), ReturnY( YSDCoord + 2 ) + 1, String, Return2X( Width ), 0, (LPINT)3, 0); //Texto SD
...
void BPCurrentLive( )
{
	...
	pDrawText(pTextThis(), Return2X(XBPCoord + TransForX( 395 )), ReturnY( YBPCoord + 3 ), String, Return2X( Width ), 0, (LPINT)3, 0); //Texto BP
