...
void InitCommon() // OK
{
	...
	SetCompleteHook(0xE8, 0x007D2B0C, &FixHelperMouseClick); //Fix //Anti-Dup
...
//--
	...
	gAdvanceStats = GetPrivateProfileIntA("Graphics","AdvanceStats",1,"./Settings.ini");
	gDamageTable = GetPrivateProfileIntA("Graphics","DamageTable",1,"./Settings.ini");
	//--
