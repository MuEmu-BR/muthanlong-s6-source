...
void CustomPet::PetsMovement(int a1, char a2)
{
	...
	if (*(BYTE *)(a1 + 4))
	{
		...
		if (Model)
		{
			...
			{
				if ((SkinID >= ITEM2(13, gProtect.m_MainInfo.FenrirDiTheoNguoiTu) && SkinID <= ITEM2(13, gProtect.m_MainInfo.FenrirDiTheoNguoiDen)) && gCustomPet2.GetInfoPetType(SkinID - 1171) == 8)//tìm index con mount
				{
				...
				else if ((SkinID >= ITEM2(13, 200) && SkinID <= ITEM2(13, 245)) && gCustomPet2.GetInfoPetType(SkinID - 1171) == 8)//muun
				{
