...
#define VIP_TAI_KHOAN_NEW	        1

#define NGU_HANH_NEW                1 

#define KINH_MACH_NEW               1

#define SHOWTIMEEVENT               1

#define CHARACTER_NEW               1
...
// Time buff
#define BUFFTIME 1 // Hiển thị thanh xanh
#define ANTI_CRACK_MAIN 1
#define UPDATE 15

// Hien tai la 3 12/02/2022
#define VANTHANH 15
